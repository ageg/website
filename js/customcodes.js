...
(function() {  
	tinymce.create('tinymce.plugins.vtabs', {  
		init : function(ed, url) {  
			ed.addButton('vtabs', {  
				title : 'Add Vertical Tabs',  
				image : url+'/../images/shortcode_icons/tabs.png',  
				onclick : function() {
					ed.selection.setContent('[vtabs vtab_1="Tab 1" vtab_2="Tab 2" vtab_3="Tab 3"][vtab id="vtab_1"]Tab content 1[/vtab][vtab id="vtab_2"]Tab content 2[/vtab][vtab id="vtab_3"]Tab content 3[/vtab][/vtabs]');
				}
			});
		},
		createControl : function(n, cm) {
	...
	tinymce.PluginManager.add('vtabs', tinymce.plugins.vtabs);
})();
	...
	tinymce.create('tinymce.plugins.posts_carousel', {
		init : function(ed, url) {
			ed.addButton('posts_carousel', {
				...
				onclick : function() {
					ed.selection.setContent('[posts_carousel heading="Latest Posts" post_type="post" category_slug="" order_by="date" order="DESC" limit="10" meta="yes" excerpt="yes" excerpt_char_limit="64" exclude_current="yes" width="four columns" scroll_by="4"][/posts_carousel]');
				}
			});
		},
		createControl : function(n, cm) {
