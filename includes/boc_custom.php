...
function menuFallBack(){
	...
	echo '<div id="menu"><ul>';
	echo '<li><a href="'.home_url('/').'" title="Accueil"><i class="fa fa-home"></i></a></li>';
	wp_list_pages(
      array(
        'title_li'  => '',
    ...
    echo '<li style="float: right;"><a href="http://ouragan.ageg.ca/" title="Serveur de fichiers"><i class="fa fa-cloud"></i></a></li>';
    echo '<li style="float: right;"><a href="#" title="Calendrier"><i class="fa fa-calendar-o"></i></a></li>';
    echo '</ul></div>';
...
function menuSelectFallBack(){
	...
	echo '<option value="#">Calendrier</option>';
	echo '<option value="http://ouragan.ageg.ca/">Serveur de fichiers Ouragan</option>';
    echo '</select>'; 		
}
